...
(function (angular) {
   ...
   angular.module("BathyApp", ['explorer.config', 'explorer.confirm', 'explorer.enter', 'explorer.flasher', 'explorer.googleanalytics', 'explorer.httpdata', 'explorer.info', 'explorer.legend', 'explorer.message', 'explorer.modal', 'explorer.persist', 'explorer.projects', 'explorer.tabs', 'explorer.version', 'exp.ui.templates', 'explorer.map.templates', 'ui.bootstrap', 'ngAutocomplete', 'ngRoute', 'ngSanitize', 'page.footer', 'geo.baselayer.control', 'geo.draw', 'geo.elevation', 'geo.geosearch', 'geo.map', 'geo.maphelper', 'geo.measure', 'bathy.autoscroll', 'bathy.daterange', 'bathy.extent', 'bathy.glossary', 'bathy.header', 'bathy.help', 'bathy.legend', 'bathy.lga', 'bathy.maps', 'bathy.panes', 'bathy.plot', 'bathy.reset', 'bathy.select', "bathy.side-panel", 'bathy.splash', 'bathy.start', 'bathy.tabs', 'bathy.templates', 'bathy.toolbar', 'bathy.wms'])
...
(function (angular) {
	...
	angular.module("bathy.lga", []).directive("bathyLga", ['$log', '$timeout', 'lgaService', function ($log, $timeout, lgaService) {
		return {
			restrict: "AE",
			templateUrl: "bathy/lga/lga.html",
			link: function link(scope, element) {
				var timeout;
	...
	}]).provider("lgaService", LgaServiceProvider).filter("bathyFilterList", function () {
	...
	function LgaServiceProvider() {
		var statesUrl = "bathy/resources/config/states.json",
		    lgasUrl = "bathy/resources/config/lgas.json",
...
(function (angular) {
	...
	angular.module("bathy.start", []).directive("bathyDownload", [function () {
		return {
...
(function (angular) {
	...
	angular.module("bathy.clip", ['geo.draw']).directive("wizardClip", ['$timeout', 'clipService', 'flashService', function ($timeout, clipService, flashService) {
		return {
...
$templateCache.put("download/start/start.html","<div>Rob\'s stuff goes here</div>");
