...
(function(angular) {
'use strict';
angular.module('mh370.baselayer.control', ['geo.maphelper', 'geo.map'])

.directive('mh370BaselayerControl', ['$rootScope', 'mapHelper', 'mapService', function($rootScope, mapHelper, mapService) {
	var DEFAULTS = {
		maxZoom: 12
	};
